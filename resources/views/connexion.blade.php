...
@section('content')
    ...
    <div class="max-w-xs w-full bg-white p-6 rounded-lg shadow-md">
        <!-- Changement ici à max-w-xs pour un formulaire plus petit -->
        ...
        <form action="/connexion" method="post">
            ...
            <div class="flex items-center justify-center">
                <input type="submit" value="Se connecter"
                       class="bg-indigo-600 text-white py-2 px-6 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 w-full">
            </div>
        </form>
    </div>
@endsection
